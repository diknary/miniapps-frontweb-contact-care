<template>
  <div>
    <div class="rpt-pdk-br__search-container">
      <div class="d-flex">
    ...
    <b-overlay :show="isLoading" rounded="sm">
      <div class="rpt-pdk-br__content-grid">
        <table id="tableReportPdkBr" class="table table-hover pl-3">
          <tbody>
            <tr>
              <th>No</th>
...
export default {
  ...
  async created() {
    ...
    if (responseJenisPdk.status && responseJenisPdk.status == 200) {
      this.pdkKindOptions = responseJenisPdk.data.data;
    }

    this.pdkKindOptions = tmpPdkKindOptions.concat(
