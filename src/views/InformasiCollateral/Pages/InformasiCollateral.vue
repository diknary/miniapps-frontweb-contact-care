<template>
  <div class="menu informasi-collateral">
    <base-error-modal
      v-if="error != null"
      isSmall
      v-bind:error="error"
    ...
    >
      ...
      <template v-slot:content>
        <collateral-info v-bind:data="viewCollateral" />
...
export default {
  ...
  methods: {
    ...mapMutations({
      changeViewCollateral: "changeViewCollateral",
    ...
    onViewCollateral(payload) {
      ...
      this.changeViewCollateral(payload);
      this.showModal = true;
    },
  },
  computed: {
    ...mapGetters({
      ...
      viewCollateral: "getViewCollateral",
